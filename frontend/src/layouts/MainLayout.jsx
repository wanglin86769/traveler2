...
const menuItems = [
  { text: 'Home', icon: <HomeIcon />, path: '/home' },
  {
    ...
    children: [
      ...
      { text: 'Public Forms', icon: <PublicIcon />, path: '/forms/public-forms' },
      { text: 'Released Forms', icon: <PublishIcon />, path: '/released-forms' },
      { text: 'Pending Reviews', icon: <ReviewIcon />, path: '/reviews/my-reviews' },
      { text: 'All Forms', icon: <LibraryIcon />, path: '/forms/all-forms', adminOnly: true }
    ]
  },
  {
    text: 'Travelers',
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={handleLogoutConfirm} variant="contained" color="primary" autoFocus>
            Confirm
          </Button>
        </DialogActions>
      </Dialog>
